"""
Django settings for getvyt project.
...
WSGI_APPLICATION = 'getvyt.wsgi.application'
...
# Csrf settings
CSRF_TRUSTED_ORIGINS = ['https://portfolio-production-34d5.up.railway.app', 'http://127.0.0.1:8000']